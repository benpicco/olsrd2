...
set (OONF_APP DLEP-Service)
set (OONF_EXE dlep-service)
set (OONF_LIBPREFIX dlepservice)
...
# set (OONF_DEFAULT_CONF "/etc/dlep-service.conf")

# setup custom text before and after default help message
set (OONF_HELP_PREFIX "Activates DLEP-service daemon\\\\n")
...
set (OONF_STATIC_PLUGINS cfgparser_compact cfgio_file dlep_service nl80211_listener)
